# ShopReact — главная страница интернет-магазина на React, Grid и Flexbox
## Описание проекта
Проект является учебным и разработан для ознакомления с возможностями языков HTML, CSS, JavaScript, а также фреймворка React. Для придания странице адаптивности используются технологии Grid и Flexbox. Используемый редактор — Visual Studio Code.
